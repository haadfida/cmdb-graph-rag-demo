"""
graph_retriever_local.py - Retrieves relevant graph context using vector similarity
Uses local sentence-transformers instead of API calls
"""
import os
...
def test_retriever():
    ...
    print("🔍 Testing Graph Retriever (Local Embeddings)\n")
